...
import { UniversityBoothModal } from '@/components/UniversityBoothModal';
...
export default function Universities() {
  ...
  useEffect(() => {
    async function fetchUniversities() {
      ...
      console.log('Fetch Universities Data:', data, 'Error:', error);

      if (!error && data) {
        // Use real data from profiles
        const augmentedData: University[] = data.map((p, idx) => {
